...
Package.onUse(function(api) {
	...
	api.use(['standard-app-packages', 'tracker', 'templating', 'underscore', 'maxharris9:template-instance-utils', 'pfafman:font-awesome-4', 'mongo-livedata', 'mquandalle:stylus@1.0.7', 'reactive-var'], 'client');
...
Package.onTest(function(api) {
	...
	//api.addFiles('datepicker-tests.js');
});
